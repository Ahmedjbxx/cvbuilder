...
const SectionItem: React.FC<SectionItemProps> = ({ 
  ...
  const [{ isDragging }, drag, dragPreview] = useDrag({
    ...
    canDrag: section.type !== 'personalDetails',
  });
...
export const FormPanel: React.FC = () => {
  ...
  return (
    <div className="h-full overflow-y-auto" style={{ userSelect: 'none' }}>
      <div className="p-0">
        {/* Sections */}
...
interface SectionContentProps {
  ...
  toggleMenu: (sectionId: string, e: React.MouseEvent) => void;
  handleRemoveSection: (sectionType: SectionType, e: React.MouseEvent) => void;
      ...
      >
        <div className="flex items-center">
          {canDrag && (
            <div 
              ref={dragRef}
              className={`drag-handle mr-3 cursor-grab active:cursor-grabbing transition-colors duration-200 ${
